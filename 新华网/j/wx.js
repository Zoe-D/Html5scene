...
wx.onMenuShareAppMessage({
 title: '青岛市“市民电影大使”征集评选活动开启啦！', // 分享标题
 desc: '只要你热爱电影就可以参与活动，还有机会赴法国参观学习哦！', // 分享描述
 
 link: document.URL, // 分享链接
 imgUrl: 'http://www.dailyqd.com/h5/smdyds/images/1.png', // 分享图标
...
wx.onMenuShareQQ({
 title: '青岛市“市民电影大使”征集评选活动开启啦！', // 分享标题
 desc: '只要你热爱电影就可以参与活动，还有机会赴法国参观学习哦！',
 link: document.URL, // 分享链接
 imgUrl: 'http://www.dailyqd.com/h5/smdyds/images/1.png', // 分享图标
 success: function () { 
 // 用户确认分享后执行的回调函数
